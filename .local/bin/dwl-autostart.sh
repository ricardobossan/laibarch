...
# Using IP-based geolocation to auto-detect coordinates
# Falls back to Brasília coordinates if API fails
LOCATION=$(curl -s "https://api.positon.xyz/v1/geolocate?key=56aba903-ae67-4f26-919b-15288b44bda9" \
