...
static const unsigned int fixedmasterwidth = 3540; /* fixed master window width in pixels (0 = use mfact instead) */
...
static uint32_t colors[][3]                = {
	...
	[SchemeSel]  = { 0x61AFEFff, 0x000000ff, 0x005577ff },
...
static const Key keys[] = {
  ...
  /* Fullscreen to screenshot file */
  { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_P,          spawn,          SHCMD("sh -c 'grim ~/Documents/Pictures/screenshots/screenshot_$(date +%Y%m%d_%H%M%S).png && notify-send \"Screenshot\" \"Fullscreen saved\"'") },
...
static const Button buttons[] = {
	...
	{ ClkStatus,   0,      BTN_LEFT,   widgetclick_left,  {0} },
	{ ClkStatus,   0,      BTN_RIGHT,  widgetclick_right, {0} },
	...
	{ ClkTagBar,   0,      BTN_MIDDLE, spawn,             {.v = termcmd} },
};
